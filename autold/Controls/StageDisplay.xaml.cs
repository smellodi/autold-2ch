...
namespace Olfactory.Controls
{
    public partial class StageDisplay : UserControl, INotifyPropertyChanged
    {
        ...
        public string DurationUnits => Duration > 0 ? (_durationUnitsAreMs ? Utils.L10n.T("Ms") : Utils.L10n.T("Seconds")) : "";
        public string DelayUnits => _delayUnitsAreMs ? Utils.L10n.T("Ms") : Utils.L10n.T("Seconds");
